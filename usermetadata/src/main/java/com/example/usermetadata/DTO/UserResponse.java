...
public class UserResponse {
	...
	public UserResponse(Long id, String username, String email, String name, String profilePicture, String coverPicture,
			String bio, String gender, String university, String college, String school, String currentLocation,
			String permanentLocation, String whatsapps, String instagram, String familyRelationships, Date dob,
	...
	public UserResponse(UserMetaData user) {
		super();
		this.id = user.getId();
		...
		this.permanentLocation = user.getPermanentLocation();
		this.whatsapps = user.getWhatsapps();
		this.instagram = user.getInstagram();
		this.familyRelationships = user.getFamilyRelationships();
